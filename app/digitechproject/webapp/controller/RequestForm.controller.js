...
function (Controller, MessageToast, MessageBox, Icon , Link , JSONModel , Fragment , Dialog ,Button , Text) {
    "use strict";

    return Controller.extend("com.digitech.digitechproject.controller.RequestForm", {
        onInit: function () {
