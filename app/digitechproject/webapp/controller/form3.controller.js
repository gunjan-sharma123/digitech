sap.ui.define([
    ...
    function (Controller, JSONModel, MessageToast, MessageBox,Icon,Link, Fragment, Dialog, Button, Text) {
        ...
        return Controller.extend("com.digitech.digitechproject.controller.form3", {
            onInit: function () {
            ...
            //                 // Loop through each attachment and handle content
            //                 oDocumentFiles.pan.forEach(function(file) {
            //                     file.fileContentURL = that._convertToBase64URL(file.content, file.mediaType);
            //                 });
            //                 oDocumentFiles.gst.forEach(function(file) {
            //                     file.fileContentURL = that._convertToBase64URL(file.content, file.mediaType);
            //                 });
            //                 oDocumentFiles.cin.forEach(function(file) {
            //                     file.fileContentURL = that._convertToBase64URL(file.content, file.mediaType);
            //                 });
            ...
            // // Utility function to convert binary content to Base64 data URL
            // _convertToBase64URL: function(binaryContent, mediaType) {
            //     var byteArray = new Uint8Array(binaryContent);
            //     var base64String = btoa(String.fromCharCode.apply(null, byteArray));
            
            //     // Correct the mediaType for common file types if necessary
            //     if (mediaType === "png") {
            //         mediaType = "image/png";
            //     } else if (mediaType === "jpg" || mediaType === "jpeg") {
