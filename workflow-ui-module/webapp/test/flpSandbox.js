		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comprocesstaskworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comprocesstaskworkflowuimodule-display": {
								"semanticObject": "comprocesstaskworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.processtask.workflowuimodule",
									"url": sap.ui.require.toUrl("com/processtask/workflowuimodule")
								}
							}
						}
					}
